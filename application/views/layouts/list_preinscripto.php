...
/////////////////////////////////////////////////////////////////////////////////////////////
   $("#carrera_total").on("change", function(event) {
    event.preventDefault();
    let base_url = "<?php echo base_url(); ?>";
    let carrera = $("#carrera_total").val();

    if ($("#carrera_total").val() != "") {

      $('#listado_preinscripto_total').DataTable({       
        dom: 'Bfrtip',
        //   buttons: [
        //   'csv', 'print'
        // ],
        ...
        destroy: true,
        "ajax": {
          url: base_url + "seguimiento/seguimiento/totalInscriptoTotal",
          type: "POST",
          dataType: "json",
          data: {
            data_carrera: carrera
