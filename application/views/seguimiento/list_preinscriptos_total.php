      ...
      <div class="col-md-12">
        ...
        <div class="card card-info">
          ...
          <div class="card-header">
            <h3 class="card-title">Listado de preinscriptos total</h3>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <select name="carrera_total" id="carrera_total" class="form-control form-control-sm">
            ...
            <div class="table-responsive">
              <table id="listado_preinscripto_total" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Cédula</th>
